...
// general parameters
params.RUN_NAME = "HaruMiniSeq20220412"
params.HOME_REPO = '/home/chartl/repos/pipelines/'
params.py_dir = params.HOME_REPO + 'py/'

// input and output
LIBRARY_DIGEST = file('Haru_0418_library_digest.csv')
SAMPLE_DIGEST = file('Haru_0418_sample_digest.csv')
params.output_dir = '/NAS1/test_runs/Haru_0418run_0427proc'
